...
public class SystemUpdatePreferenceController extends BasePreferenceController {
    ...
    private static final String OTA_BUILD_TYPE_PROP = "ro.candy.releasetype";
    private static final String DEVICE_NAME = "ro.candy.device";
    private static final String OTA_APP_PACKAGE = "org.candy.updater";
    ...
    public CharSequence getSummary() {
        CharSequence summary = mContext.getString(R.string.update_settings_summary);
        return summary;
    }
